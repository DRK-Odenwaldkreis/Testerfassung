...
def create_PDFs(content, date, station):
    ...
    pdfcontent = [station, tests, positiv, negativ, unklar, times, age, children, CWA_anonym, CWA_named, pre_reg, poc_reg]
...
if __name__ == "__main__":
    try:
        ...
        for station in teststationen:
            sql = "Select id,Ergebnis,Ergebniszeitpunkt,Teststation,TIMEDIFF(Ergebniszeitpunkt,Registrierungszeitpunkt),Geburtsdatum,reg_type,CWA_request from Vorgang where Teststation = %s and Ergebniszeitpunkt Between '%s 00:00:00' and '%s 23:59:59';" % (station[0],
