...
if(!$GLOBALS['FLAG_SHUTDOWN_MAIN']) {
	...
	if($ALLOWANCE_RESULT>0) {
		...
		$display_result=str_replace('[[QRURL]]', 'https://www.testzentrum-odw.de/result.php?validate=1%26i='.$token.'%26t='.$key.'%26g='.$geburtsdatum.'' , $display_result);		echo '<div style="margin-top:20px;">
