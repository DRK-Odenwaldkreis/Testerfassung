...
if( A_checkpermission(array(0,2,0,4,0)) ) {
    ...
    <thead>
      ...
      if($GLOBALS['FLAG_MODE_MAIN'] == 1) {
        ...
        <td class="FAIR-data-height2 FAIR-data-right FAIR-data-left FAIR-data-bottom FAIR-data-top"><h4>Typ (1=Ag; 2=PCR)</h4></td>
        <td class="FAIR-data-height2 FAIR-data-right FAIR-data-left FAIR-data-bottom FAIR-data-top"><h4>Aktiv (1=Ja)</h4></td>
        <td class="FAIR-data-height2 FAIR-data-right FAIR-data-left FAIR-data-bottom FAIR-data-top"><h4>Intern (1=Ja)</h4></td>';
      }
      echo '
      </tr>
      </thead>
