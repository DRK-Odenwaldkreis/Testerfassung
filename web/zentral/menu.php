...
if($GLOBALS['FLAG_MODE_MAIN'] == 1) {
  $_module_array1=array(
    ...
    17=>array("text"=>'<h4 class="list-group-item-heading">Mitarbeiterinfos</h4><p class="list-group-item-text">Aktuelle Mitarbeiterinfos</p>',"link"=>"news.php","text_s"=>'<span class="icon-info2"></span>&nbsp;Mitarbeiterinfos',"role"=>array(1,2,3,4,5),"role-disabled"=>array(0,0,0,0,0)),
  ...
  $_module_array2=array(
    ...
    25=>array("text"=>'<h4 class="list-group-item-heading">Termin-Überblick</h4><p class="list-group-item-text">Übersicht der angelegten Termine</p>',"text_s"=>'<span class="icon-calendar2"></span>&nbsp;Termin-Überblick',"link"=>"terminlist.php","role"=>array(0,2,0,4,0),"role-disabled"=>array(1,0,0,0,0)),
    ...
    31=>array("text"=>'<h4 class="list-group-item-heading">Testgründe Anpassen</h4><p class="list-group-item-text">Testgründe anpassen/ändern</p>',"text_s"=>'<span class="icon-stack"></span>&nbsp;Testgründe',"link"=>"gruende.php","role"=>array(0,2,0,4,0),"role-disabled"=>array(0,0,0,0,0)),
    41=>array("text"=>'<h4 class="list-group-item-heading">Admin: Web user</h4><p class="list-group-item-text">User-Management</p>',"text_s"=>'<span class="icon-users"></span>&nbsp;User-Management',"link"=>"user_admin.php","role"=>array(0,0,0,4,0),"role-disabled"=>array(0,2,0,0,0)),
    43=>array("text"=>'<h4 class="list-group-item-heading">Admin: Files</h4><p class="list-group-item-text">Dateien</p>',"text_s"=>'',"link"=>"downloadlist.php","role"=>array(0,0,0,4,0),"role-disabled"=>array(0,0,0,0,0)),
    44=>array("text"=>'<h4 class="list-group-item-heading">Admin: Logs</h4><p class="list-group-item-text">Übersicht der Logs</p>',"text_s"=>'',"link"=>"log.php","role"=>array(0,0,0,4,0),"role-disabled"=>array(0,0,0,0,0)),
  );
} else {
  $_module_array1=array(
  ...
  $_module_array2=array(
    20=>array("text"=>'<h4 class="list-group-item-heading">Stationen</h4><p class="list-group-item-text">Stations-Management</p>',"text_s"=>'<span class="icon-office"></span>&nbsp;Stationen',"link"=>"station_admin.php","role"=>array(0,2,0,4,0),"role-disabled"=>array(0,0,0,0,0)),
    25=>array("text"=>'<h4 class="list-group-item-heading">Termin-Überblick</h4><p class="list-group-item-text">Übersicht der angelegten Termine</p>',"text_s"=>'<span class="icon-calendar2"></span>&nbsp;Termin-Überblick',"link"=>"terminlist.php","role"=>array(0,2,0,4,0),"role-disabled"=>array(1,0,0,0,0)),
    26=>array("text"=>'<h4 class="list-group-item-heading">Termine erstellen</h4><p class="list-group-item-text">Neue Termine für einen Impfstoff erstellen</p>',"text_s"=>'<span class="icon-cogs"></span>&nbsp;Termin-Verwaltung',"link"=>"terminerstellung.php","role"=>array(0,2,0,4,0),"role-disabled"=>array(1,0,0,0,0)),
    30=>array("text"=>'<h4 class="list-group-item-heading">Impstoffe Anpassen</h4><p class="list-group-item-text">Impfstoff anpassen/ändern</p>',"text_s"=>'<span class="icon-stack"></span>&nbsp;Testkits',"link"=>"material.php","role"=>array(0,2,0,4,0),"role-disabled"=>array(0,0,0,0,0)),
    41=>array("text"=>'<h4 class="list-group-item-heading">Admin: Web user</h4><p class="list-group-item-text">User-Management</p>',"text_s"=>'<span class="icon-users"></span>&nbsp;User-Management',"link"=>"user_admin.php","role"=>array(0,0,0,4,0),"role-disabled"=>array(0,2,0,0,0)),
    43=>array("text"=>'<h4 class="list-group-item-heading">Admin: Files</h4><p class="list-group-item-text">Dateien</p>',"text_s"=>'',"link"=>"downloadlist.php","role"=>array(0,0,0,4,0),"role-disabled"=>array(0,0,0,0,0)),
    44=>array("text"=>'<h4 class="list-group-item-heading">Admin: Logs</h4><p class="list-group-item-text">Übersicht der Logs</p>',"text_s"=>'',"link"=>"log.php","role"=>array(0,0,0,4,0),"role-disabled"=>array(0,0,0,0,0)),
  );
