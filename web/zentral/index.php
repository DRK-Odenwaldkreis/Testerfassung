...
$_module_array=array(
    ...
    10=>array("text"=>'<h4 class="list-group-item-heading">Liste an Tests</h4><p class="list-group-item-text">Aktive Tests und Export CSV</p>',"link"=>"testlist.php","role"=>array(1,2,0,4),"role-disabled"=>array(0,0,0,0)),
    15=>array("text"=>'<h4 class="list-group-item-heading">Liste an Positivmeldungen</h4><p class="list-group-item-text">Positivmeldungen und Export CSV</p>',"link"=>"gesundheitsamt.php","role"=>array(0,0,3,4),"role-disabled"=>array(0,0,0,0)),
