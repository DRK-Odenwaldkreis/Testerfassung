...
$_module_array=array(
    ...
    20=>array("text"=>'<h4 class="list-group-item-heading">Testkarten</h4><p class="list-group-item-text">Erstellung von neuen Testkarten</p>',"link"=>"testkarten.php","role"=>array(0,2,0,4,0),"role-disabled"=>array(0,0,0,0,5)),
